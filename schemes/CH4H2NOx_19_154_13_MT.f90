...
!--------------------------------------------------------------------------------------------------
!     FILE ./database/S19R154QSS13_2/S19R154QSS13_2.f90
!>    @file ./database/S19R154QSS13_2/S19R154QSS13_2.f90
...
module mod_customkinetics
  ...
  integer, parameter :: nreac_reverse = 134
  ...
  integer, parameter :: sHO2 = 16
  integer, parameter :: sNO = 17
  integer, parameter :: sNO2 = 18
  integer, parameter :: sHNO = 19

  integer, parameter :: sqssCH3OH = 1
  integer, parameter :: sqssCH3O = 2
  integer, parameter :: sqssCH2OH = 3
  integer, parameter :: sqssHCO = 4
  integer, parameter :: sqssC2H5 = 5
  integer, parameter :: sqssC2H4 = 6
  integer, parameter :: sqssC2H3 = 7
  integer, parameter :: sqssCH2CO = 8
  integer, parameter :: sqssN2O = 9
  integer, parameter :: sqssN = 10
  integer, parameter :: sqssN2H = 11
  integer, parameter :: sqssNH2 = 12
  ...
  integer, parameter :: r22b = 175
  integer, parameter :: r23b = 176
  integer, parameter :: r24b = 177
  integer, parameter :: r25b = 178
  integer, parameter :: r26b = 179
  integer, parameter :: r27b = 180
  integer, parameter :: r28b = 181
  integer, parameter :: r29b = 182
  integer, parameter :: r32b = 183
  integer, parameter :: r33b = 184
  integer, parameter :: r34b = 185
  integer, parameter :: r35b = 186
  integer, parameter :: r36b = 187
  ...
  integer, parameter :: r98b = 247
  integer, parameter :: r99b = 248
  integer, parameter :: r100b = 249
  integer, parameter :: r101b = 250
  integer, parameter :: r102b = 251
  integer, parameter :: r103b = 252
  integer, parameter :: r104b = 253
  integer, parameter :: r105b = 254
  integer, parameter :: r106b = 255
  integer, parameter :: r107b = 256
  integer, parameter :: r108b = 257
  integer, parameter :: r109b = 258
  integer, parameter :: r110b = 259
  integer, parameter :: r111b = 260
  integer, parameter :: r112b = 261
  integer, parameter :: r113b = 262
  integer, parameter :: r117b = 263
  integer, parameter :: r119b = 264
  integer, parameter :: r120b = 265
  integer, parameter :: r121b = 266
  integer, parameter :: r122b = 267
  integer, parameter :: r123b = 268
  integer, parameter :: r124b = 269
  integer, parameter :: r127b = 270
  integer, parameter :: r131b = 271
  integer, parameter :: r138b = 272
  integer, parameter :: r139b = 273
  integer, parameter :: r140b = 274
  integer, parameter :: r141b = 275
  integer, parameter :: r142b = 276
  integer, parameter :: r143b = 277
  integer, parameter :: r144b = 278
  integer, parameter :: r145b = 279
  integer, parameter :: r146b = 280
  integer, parameter :: r147b = 281
  integer, parameter :: r148b = 282
  integer, parameter :: r149b = 283
  integer, parameter :: r150b = 284
  integer, parameter :: r151b = 285
  integer, parameter :: r152b = 286
  integer, parameter :: r153b = 287
  integer, parameter :: r154b = 288
  ...
  integer, parameter :: mM108 = 22
  integer, parameter :: mM146 = 23
  ...
  integer, parameter :: TBr149f = 6
  integer, parameter :: TBr4b = 7
  integer, parameter :: TBr63b = 8
  integer, parameter :: TBr82b = 9
  integer, parameter :: TBr117b = 10
  integer, parameter :: TBr149b = 11
  ...
  integer, parameter :: FOr108b = 33
  integer, parameter :: FOr146b = 34
...
contains
  ...
  subroutine get_thirdbodies(M,c)
    ...
    M(mM108) = (1.000000e+00_pr)*c(sCH4) &
         + (5.000000e-01_pr)*c(sCO) &
         + (1.000000e+00_pr)*c(sCO2) &
         + (5.000000e+00_pr)*c(sH2O) &
         + sum(c)

    M(mM146) = (9.000000e+00_pr)*c(sH2O) &
  ...
  subroutine get_rate_coefficients(k,M,Tloc,Ploc)
    ...
    k(r105f) = (1.000000e+01_pr)*exp((-2.510400e+04_pr)*R_T_inv + (2.000000e+00_pr)*T_log )
    k(r106f) = (7.528000e+00_pr)*exp((-8.811504e+03_pr)*R_T_inv + (1.550000e+00_pr)*T_log )
    k(r107f) = (1.277000e+03_pr)*exp((-1.079054e+04_pr)*R_T_inv + (7.300000e-01_pr)*T_log )
    k_0(FOr108f) =(3.000000e+09_pr)*exp((-2.384880e+05_pr)*R_T_inv )
    k_inf(FOr108f) =(3.000000e+13_pr)*exp((-2.970640e+05_pr)*R_T_inv )
    redP = abs(k_0(FOr108f)) * M(mM108) / max(abs(k_inf(FOr108f)), tiny(1.0_pr)) + tiny(1.0_pr)
    k(r108f) = k_inf(FOr108f) * redP / ( 1.0_pr + redP )
    k(r109f) = (3.000000e+07_pr)
    k(r110f) = (7.770000e+02_pr)*exp((-1.163152e+04_pr)*R_T_inv + (1.450000e+00_pr)*T_log )
    k(r111f) = (2.000000e+06_pr)*exp((4.225840e+03_pr)*R_T_inv )
    k(r112f) = (4.160000e+18_pr)*exp((-4.083584e+04_pr)*R_T_inv + (-3.190000e+00_pr)*T_log )
    k(r113f) = (4.920000e+03_pr)*exp((-2.509438e+03_pr)*R_T_inv + (1.020000e+00_pr)*T_log )
    k(r114f) = (1.000000e+07_pr)*exp((-6.276000e+04_pr)*R_T_inv )
    k(r115f) = (2.000000e+07_pr)*exp((-9.623200e+03_pr)*R_T_inv )
    k(r116f) = (1.000000e+07_pr)
    k(r117f) = (1.000000e+04_pr)
    k(r118f) = (1.000000e+08_pr)*exp((-1.004160e+05_pr)*R_T_inv )
    k(r119f) = (1.078469e+08_pr)*exp((-2.031268e+03_pr)*R_T_inv + (-2.145491e-01_pr)*T_log )
    k(r120f) = (2.696171e+08_pr)*exp((-2.031268e+03_pr)*R_T_inv + (-2.145491e-01_pr)*T_log )
    k(r121f) = (1.617703e+08_pr)*exp((-2.031268e+03_pr)*R_T_inv + (-2.145491e-01_pr)*T_log )
    k(r122f) = (5.931577e+05_pr)*exp((-6.215269e+03_pr)*R_T_inv + (-2.145491e-01_pr)*T_log )
    k(r123f) = (1.871156e-01_pr)*exp((1.763074e+04_pr)*R_T_inv + (1.988656e+00_pr)*T_log )
    k(r124f) = (2.681990e-01_pr)*exp((1.763074e+04_pr)*R_T_inv + (1.988656e+00_pr)*T_log )
    k(r125f) = (5.000000e+08_pr)*exp((-1.338880e+05_pr)*R_T_inv )
    k(r126f) = (6.470811e+08_pr)*exp((-2.031268e+03_pr)*R_T_inv + (-2.145491e-01_pr)*T_log )
    k(r127f) = (3.000000e+13_pr)*exp((-3.284440e+05_pr)*R_T_inv )
    k(r128f) = (2.000000e+07_pr)*exp((-2.092000e+04_pr)*R_T_inv )
    k(r129f) = (1.000000e+05_pr)
    k(r130f) = (5.000000e+06_pr)*exp((-6.276000e+04_pr)*R_T_inv )
    k(r131f) = (5.000000e+05_pr)*exp((-2.719600e+04_pr)*R_T_inv )
    k(r132f) = (3.000000e+05_pr)*exp((-1.087840e+05_pr)*R_T_inv )
    k(r133f) = (1.000000e+08_pr)*exp((-2.008320e+05_pr)*R_T_inv )
    k(r134f) = (3.000000e+05_pr)*exp((-1.129680e+05_pr)*R_T_inv )
    k(r135f) = (1.000000e+08_pr)*exp((-1.799120e+05_pr)*R_T_inv )
    k(r136f) = (5.000000e+04_pr)
    k(r137f) = (1.500000e+07_pr)
    k(r138f) = (1.083000e+01_pr)*exp((-3.674372e+04_pr)*R_T_inv + (2.000000e+00_pr)*T_log )
    k(r139f) = (2.800000e+14_pr)*exp((-5.263472e+03_pr)*R_T_inv + (-2.654000e+00_pr)*T_log )
    k(r140f) = (3.100000e+07_pr)*exp((-4.937120e+03_pr)*R_T_inv + (-4.800000e-01_pr)*T_log )
    k(r141f) = (9.200000e+07_pr)
    k(r142f) = (1.800000e+08_pr)*exp((1.020896e+03_pr)*R_T_inv + (-3.510000e-01_pr)*T_log )
    k(r143f) = (2.200000e+07_pr)*exp((-2.300000e-01_pr)*T_log )
    k(r144f) = (1.470000e+07_pr)*exp((-3.150000e+05_pr)*R_T_inv + (3.000000e-01_pr)*T_log )
    k(r145f) = (2.100000e+06_pr)*exp((2.009994e+03_pr)*R_T_inv )
    k_0(FOr146f) =(2.300000e+02_pr)*exp((6.505994e+03_pr)*R_T_inv + (2.060000e-01_pr)*T_log )
    k_inf(FOr146f) =(1.500000e+09_pr)*exp((-4.000000e-01_pr)*T_log )
    redP = abs(k_0(FOr146f)) * M(mM146) / max(abs(k_inf(FOr146f)), tiny(1.0_pr)) + tiny(1.0_pr)
    k(r146f) = k_inf(FOr146f) * redP / ( 1.0_pr + redP )
    k(r147f) = (3.500000e+08_pr)*exp((-6.280017e+03_pr)*R_T_inv )
    k(r148f) = (1.000000e+07_pr)*exp((-2.509982e+03_pr)*R_T_inv )
    k(r149f) = (1.100000e+10_pr)*exp((-2.760000e+05_pr)*R_T_inv )
    k(r150f) = (3.600000e+07_pr)
    k(r151f) = (4.400000e+05_pr)*exp((-2.720018e+03_pr)*R_T_inv + (7.200000e-01_pr)*T_log )
    k(r152f) = (6.400000e+03_pr)*exp((-2.630000e+04_pr)*R_T_inv + (1.000000e+00_pr)*T_log )
    k(r153f) = (3.800000e+07_pr)
    k(r154f) = (9.150000e+07_pr)*exp((-1.158675e+05_pr)*R_T_inv )
    ...
    k(r105b) = (4.293125e-02_pr)*exp((-1.080731e+05_pr)*R_T_inv + (2.719809e+00_pr)*T_log )
    k(r106b) = (4.423727e+03_pr)*exp((-1.070599e+05_pr)*R_T_inv + (9.688953e-01_pr)*T_log )
    k(r107b) = (1.172251e+00_pr)*exp((-2.379702e+05_pr)*R_T_inv + (1.655169e+00_pr)*T_log )
    k_0(FOr108b) =(1.683199e-04_pr)*exp((1.112203e+05_pr)*R_T_inv + (1.476046e+00_pr)*T_log )
    k_inf(FOr108b) =(1.683199e+00_pr)*exp((5.264429e+04_pr)*R_T_inv + (1.476046e+00_pr)*T_log )
    redP = abs(k_0(FOr108b)) * M(mM108) / max(abs(k_inf(FOr108b)), tiny(1.0_pr)) + tiny(1.0_pr)
    k(r108b) = k_inf(FOr108b) * redP / ( 1.0_pr + redP )
    k(r109b) = (2.179971e+11_pr)*exp((-3.780213e+05_pr)*R_T_inv + (-8.343004e-01_pr)*T_log )
    k(r110b) = (1.213786e-03_pr)*exp((-1.405627e+05_pr)*R_T_inv + (2.956274e+00_pr)*T_log )
    k(r111b) = (1.068798e+04_pr)*exp((-1.106253e+05_pr)*R_T_inv + (6.641406e-01_pr)*T_log )
    k(r112b) = (1.232240e+18_pr)*exp((-5.852021e+04_pr)*R_T_inv + (-3.220477e+00_pr)*T_log )
    k(r113b) = (1.457361e+03_pr)*exp((-2.019380e+04_pr)*R_T_inv + (9.895228e-01_pr)*T_log )
    k(r117b) = (9.767603e+11_pr)*exp((-2.734300e+05_pr)*R_T_inv + (-1.989404e-01_pr)*T_log )
    k(r119b) = (1.819099e+09_pr)*exp((-4.166910e+05_pr)*R_T_inv + (-8.890438e-02_pr)*T_log )
    k(r120b) = (4.575219e+09_pr)*exp((-7.698889e+05_pr)*R_T_inv + (-1.104457e-01_pr)*T_log )
    k(r121b) = (1.898225e+12_pr)*exp((-3.419555e+05_pr)*R_T_inv + (-6.706405e-01_pr)*T_log )
    k(r122b) = (5.522442e+03_pr)*exp((-2.401304e+05_pr)*R_T_inv + (4.222542e-01_pr)*T_log )
    k(r123b) = (1.809518e-05_pr)*exp((-3.174854e+05_pr)*R_T_inv + (1.708338e+00_pr)*T_log )
    k(r124b) = (6.837661e-01_pr)*exp((-2.292692e+04_pr)*R_T_inv + (1.733402e+00_pr)*T_log )
    k(r127b) = (9.788358e+04_pr)*exp((-1.921333e+05_pr)*R_T_inv + (2.479523e-01_pr)*T_log )
    k(r131b) = (4.723849e+06_pr)*exp((-1.838119e+05_pr)*R_T_inv + (6.650776e-02_pr)*T_log )
    k(r138b) = (1.009662e-02_pr)*exp((-2.510337e+03_pr)*R_T_inv + (2.310491e+00_pr)*T_log )
    k(r139b) = (6.754670e+14_pr)*exp((-5.264968e+05_pr)*R_T_inv + (-2.342818e+00_pr)*T_log )
    k(r140b) = (8.430356e+07_pr)*exp((1.020371e+03_pr)*R_T_inv + (-6.753410e-01_pr)*T_log )
    k(r141b) = (3.119306e+09_pr)*exp((-2.977215e+05_pr)*R_T_inv + (-2.100360e-01_pr)*T_log )
    k(r142b) = (3.673989e+14_pr)*exp((-1.512269e+05_pr)*R_T_inv + (-1.447816e+00_pr)*T_log )
    k(r143b) = (5.062807e+07_pr)*exp((-4.104185e+05_pr)*R_T_inv + (-6.496859e-02_pr)*T_log )
    k(r144b) = (7.933756e+06_pr)*exp((-6.615277e+02_pr)*R_T_inv + (1.968704e-01_pr)*T_log )
    k(r145b) = (9.401776e+07_pr)*exp((-3.068419e+04_pr)*R_T_inv + (-2.855353e-01_pr)*T_log )
    k_0(FOr146b) =(8.402535e+08_pr)*exp((-1.991638e+05_pr)*R_T_inv + (2.908658e-01_pr)*T_log )
    k_inf(FOr146b) =(5.479913e+15_pr)*exp((-2.056698e+05_pr)*R_T_inv + (-3.151342e-01_pr)*T_log )
    redP = abs(k_0(FOr146b)) * M(mM146) / max(abs(k_inf(FOr146b)), tiny(1.0_pr)) + tiny(1.0_pr)
    k(r146b) = k_inf(FOr146b) * redP / ( 1.0_pr + redP )
    k(r147b) = (7.013613e+03_pr)*exp((-1.268776e+05_pr)*R_T_inv + (8.556718e-01_pr)*T_log )
    k(r148b) = (4.515375e+04_pr)*exp((-1.928993e+05_pr)*R_T_inv + (5.203546e-01_pr)*T_log )
    k(r149b) = (2.515441e+00_pr)*exp((3.012419e+04_pr)*R_T_inv + (4.844757e-01_pr)*T_log )
    k(r150b) = (6.288571e+06_pr)*exp((-2.887103e+05_pr)*R_T_inv + (3.333041e-01_pr)*T_log )
    k(r151b) = (2.113400e+04_pr)*exp((-2.297917e+05_pr)*R_T_inv + (1.019555e+00_pr)*T_log )
    k(r152b) = (7.753536e+02_pr)*exp((-1.581497e+05_pr)*R_T_inv + (1.063379e+00_pr)*T_log )
    k(r153b) = (1.037346e+09_pr)*exp((-2.016415e+05_pr)*R_T_inv + (-2.719378e-01_pr)*T_log )
    k(r154b) = (1.519938e+03_pr)*exp((-2.613412e+05_pr)*R_T_inv + (8.867801e-01_pr)*T_log )
  ...
  subroutine get_reaction_rates(w,k,m,c,cqss)
    ...
    w(r130f) = k(r130f) * c(sC2H2) * c(sHO2) 
    ...
    w(r139f) = k(r139f) * cqss(sqssNH2) * c(sNO) 
    w(r140f) = k(r140f) * cqss(sqssNH2) * c(sNO) 
    w(r141f) = k(r141f) * cqss(sqssNH) * c(sO) 
    w(r142f) = k(r142f) * cqss(sqssNH) * c(sNO) 
    w(r143f) = k(r143f) * cqss(sqssNH) * c(sNO) 
    w(r144f) = k(r144f) * c(sN2) * c(sO) 
    w(r145f) = k(r145f) * c(sHO2) * c(sNO) 
    w(r146f) = k(r146f) * c(sH) * c(sNO) 
    w(r147f) = k(r147f) * c(sH) * c(sNO2) 
    w(r148f) = k(r148f) * c(sNO2) * c(sO) 
    w(r149f) = k(r149f) * c(sNO2) * m(mM149)
    w(r150f) = k(r150f) * c(sHNO) * c(sOH) 
    w(r151f) = k(r151f) * c(sH) * c(sHNO) 
    w(r152f) = k(r152f) * cqss(sqssN) * c(sO2) 
    w(r153f) = k(r153f) * cqss(sqssN) * c(sOH) 
    w(r154f) = k(r154f) * cqss(sqssN2O) * c(sO) 
    ...
    w(r90b) = k(r90b) * c(sC2H2) * c(sHO2) 
    w(r91b) = k(r91b) * c(sC2H2) * c(sHO2) 
    ...
    w(r139b) = k(r139b) * c(sH2O) * c(sN2) 
    w(r140b) = k(r140b) * cqss(sqssN2H) * c(sOH) 
    w(r141b) = k(r141b) * c(sH) * c(sNO) 
    w(r142b) = k(r142b) * c(sH) * cqss(sqssN2O) 
    w(r143b) = k(r143b) * c(sN2) * c(sOH) 
    w(r144b) = k(r144b) * cqss(sqssN) * c(sNO) 
    w(r145b) = k(r145b) * c(sNO2) * c(sOH) 
    w(r146b) = k(r146b) * c(sHNO) 
    w(r147b) = k(r147b) * c(sNO) * c(sOH) 
    w(r148b) = k(r148b) * c(sNO) * c(sO2) 
    w(r149b) = k(r149b) * c(sNO) * c(sO) * m(mM149)
    w(r150b) = k(r150b) * c(sH2O) * c(sNO) 
    w(r151b) = k(r151b) * c(sH2) * c(sNO) 
    w(r152b) = k(r152b) * c(sNO) * c(sO) 
    w(r153b) = k(r153b) * c(sH) * c(sNO) 
    w(r154b) = k(r154b) * c(sNO)**2.0_pr 
  ...
  subroutine get_qss(cqss,c,k,M)
    ...
    C2H3_num = ( 0.0_pr &
             + k(r89f)* c(sC2H2) * c(sH) &
             + k(r90b)* c(sC2H2) * c(sHO2) &
             + k(r91b)* c(sC2H2) * c(sHO2) &
    ...
    a_i_a =  (1.0_pr) - (CH3OH_CH3O) * (CH3O_CH3OH)
    a_j_a =  - (CH3OH_CH2OH) * (CH3O_CH3OH)
    a_q_a =  - (CH3OH_CH3O) * (CH2OH_CH3OH)
    a_r_a =  (1.0_pr) - (CH3OH_CH2OH) * (CH2OH_CH3OH)
    a_aw_a = C2H3_CH3O
    a_bf_a = CH2CO_CH2OH
    a_t_b =  - (CH3O_C2H5) * (a_q_a) / (a_i_a)
    a_u_b =  - (CH3O_C2H4) * (a_q_a) / (a_i_a)
    a_v_b =  - (CH3O_C2H3) * (a_q_a) / (a_i_a)
    a_ac_b = HCO_C2H4
    a_ad_b = HCO_C2H3
    a_aj_b = 1.0_pr
    a_ak_b = C2H5_C2H4
    ...
    a_as_b = 1.0_pr
    a_at_b = C2H4_C2H3
    a_bz_b =  - (CH3O_C2H5) * (a_aw_a) / (a_i_a)
    a_ba_b =  (C2H3_C2H4) - (CH3O_C2H4) * (a_aw_a) / (a_i_a)
    a_bb_b =  (1.0_pr) - (CH3O_C2H3) * (a_aw_a) / (a_i_a)
    a_bj_b = CH2CO_C2H3
    a_ae_c = HCO_CH2CO
    a_bc_c = C2H3_CH2CO
    a_bk_c =  (1.0_pr) - (CH2OH_CH2CO) * (a_bf_a) / (a_r_a)
    a_ak_d = a_ak_b
    a_as_d =  (a_as_b) - (a_ac_b) * (C2H4_HCO)
    a_at_d =  (a_at_b) - (a_ad_b) * (C2H4_HCO)
    a_au_d =  - (a_ae_c) * (C2H4_HCO)
    a_ba_d =  (a_ba_b) - (a_ac_b) * (C2H3_HCO)
    a_bb_d =  (a_bb_b) - (a_ad_b) * (C2H3_HCO)
    a_bc_d =  (a_bc_c) - (a_ae_c) * (C2H3_HCO)
    a_bj_d = a_bj_b
    a_bk_d = a_bk_c
    a_as_e =  (a_as_d) - (a_ak_d) * (a_ar_b) / (a_aj_b)
    a_ba_e =  (a_ba_d) - (a_ak_d) * (a_bz_b) / (a_aj_b)
    a_bb_f =  (a_bb_d) - (a_at_d) * (a_ba_e) / (a_as_e)
    a_bj_f = a_bj_d
    a_bk_g =  (a_bk_d) - (a_bc_d) * (a_bj_f) / (a_bb_f)
    A_A_A =  (CH3O_ct) - (CH3OH_ct) * (CH3O_CH3OH)
    A_B_A =  (CH2OH_ct) - (CH3OH_ct) * (CH2OH_CH3OH)
    A_C_A = HCO_ct
    A_D_A = C2H5_ct
    A_E_A = C2H4_ct
    A_F_A = C2H3_ct
    A_G_A = CH2CO_ct
    A_B_B =  (A_B_A) - (A_A_A) * (a_q_a) / (a_i_a)
    A_C_B = A_C_A
    A_D_B = A_D_A
    A_E_B = A_E_A
    A_F_B =  (A_F_A) - (A_A_A) * (a_aw_a) / (a_i_a)
    A_G_B = A_G_A
    A_C_C = A_C_B
    A_D_C = A_D_B
    A_E_C = A_E_B
    A_F_C = A_F_B
    A_G_C =  (A_G_B) - (A_B_B) * (a_bf_a) / (a_r_a)
    A_D_D = A_D_C
    A_E_D =  (A_E_C) - (A_C_C) * (C2H4_HCO)
    A_F_D =  (A_F_C) - (A_C_C) * (C2H3_HCO)
    A_G_D = A_G_C
    A_E_E =  (A_E_D) - (A_D_D) * (a_ar_b) / (a_aj_b)
    A_F_E =  (A_F_D) - (A_D_D) * (a_bz_b) / (a_aj_b)
    A_G_E = A_G_D
    A_F_F =  (A_F_E) - (A_E_E) * (a_ba_e) / (a_as_e)
    A_G_F = A_G_E
    A_G_G =  (A_G_F) - (A_F_F) * (a_bj_f) / (a_bb_f)

    cqss(sqssCH2CO) = ( A_G_G ) / ( a_bk_g )  

    cqss(sqssC2H3) = (A_F_F - (a_bc_d) * cqss(sqssCH2CO)) / (a_bb_f)  

    cqss(sqssC2H4) = (A_E_E - (a_au_d) * cqss(sqssCH2CO) - (a_at_d) &
                 * cqss(sqssC2H3)) / (a_as_e)  

    cqss(sqssC2H5) = (A_D_D - (a_ak_d) * cqss(sqssC2H4)) / (a_aj_b)  

    cqss(sqssHCO) = A_C_C - (a_ae_c) * cqss(sqssCH2CO) - (a_ad_b) &
                 * cqss(sqssC2H3) - (a_ac_b) * cqss(sqssC2H4)  

    cqss(sqssCH2OH) = (A_B_B - (CH2OH_CH2CO) * cqss(sqssCH2CO) - (a_v_b) &
                 * cqss(sqssC2H3) - (a_u_b) * cqss(sqssC2H4) &
                 - (a_t_b) * cqss(sqssC2H5)) / (a_r_a)  

    cqss(sqssCH3O) = (A_A_A - (CH3O_C2H3) * cqss(sqssC2H3) - (CH3O_C2H4) &
                 * cqss(sqssC2H4) - (CH3O_C2H5) * cqss(sqssC2H5) &
                 - (a_j_a) * cqss(sqssCH2OH)) / (a_i_a)  

    cqss(sqssCH3OH) = CH3OH_ct - (CH3OH_CH2OH) * cqss(sqssCH2OH) &
                 - (CH3OH_CH3O) * cqss(sqssCH3O)  
    ...
    N2O_num = ( 0.0_pr &
             + k(r154b) *c(sNO)** 2.0_pr  )

    N2O_ct = N2O_num / N2O_denom

    N2O_NH = - ( 0.0_pr &
          + k(r142f) * c(sNO)  ) / N2O_denom

    b_c_a =  (1.0_pr) - (N2O_NH) * (NH_N2O)
    B_A_A =  (NH_ct) - (N2O_ct) * (NH_N2O)

    cqss(sqssNH) = ( B_A_A ) / ( b_c_a )  

    cqss(sqssN2O) = N2O_ct - (N2O_NH) * cqss(sqssNH)  
    ...
    NH2_num = ( 0.0_pr &
             + k(r139b)* c(sH2O) * c(sN2)   )

    NH2_ct = NH2_num / NH2_denom

    NH2_N2H = - ( 0.0_pr &
          + k(r140b) * c(sOH)  ) / NH2_denom
    ...
    N2H_NH2 = - ( 0.0_pr &
          + k(r140f) * c(sNO)  ) / N2H_denom

    c_c_a =  (1.0_pr) - (N2H_NH2) * (NH2_N2H)
    C_A_A =  (NH2_ct) - (N2H_ct) * (NH2_N2H)

    cqss(sqssNH2) = ( C_A_A ) / ( c_c_a )  
