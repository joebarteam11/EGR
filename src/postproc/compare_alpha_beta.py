...
files=[
    ...
    # '/1DREAL_EGR_AP1bar1_M12noh2o.csv',
    # '/1DREAL_EGR_AP1bar2_M12noh2o.csv',
    '/1DREAL_EGR_AP1bar0_M12.csv',
...
titles = ['CH4 mole fraction at inlet',
          'N2 mole fraction at inlet',
          'CO2 mole fraction at inlet',
          'H2O mole fraction at inlet',
    #'Flame thickness',
          #'Laminar flame speed',
