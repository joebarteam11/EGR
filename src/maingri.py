...
if __name__ == '__main__':
    ...
    if rank_0:
        ...
        templistOx = [600] #[i for i in np.arange(450,660,50.0)]
        templistFuel = templistOx #[i for i in np.arange(290,305,10.0)]
        templistEGR = templistOx
        presslist= [1.0E5,5e5]#[1.0E5,10e5,25e5] #[i for i in np.arange(1E5,1.4E5,0.2E5)]
    ...
    restart_rate = None
    if (real_egr):
        save_file_name = path + "/results/" + dim + "_EGR600_jan24_AP" + ".csv"
    else:
        save_file_name = path + "/results/" + dim + "_N2_jan24_gri3" + ".csv"
