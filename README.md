...
With:
$\begin{cases}
H_{reac}\left(T\right)=1h_{CH_{4}}^{m}\left(T\right)+2h_{O_{2}}^{m}\left(T\right)+7,52h_{N_{2}}^{m}\left(T\right)\\H_{CO_{2},r\acute{e}inj}\left(T\right)=zh_{CO_{2}}^{m}\left(T\right)\\
